...
class ParaViewLite(pv_protocols.ParaViewWebProtocol):
    ...
    def prepareSnappyHexMeshDict(self, path, surfaces):
      try:
        ...
        writeFile.write('    format	ascii;\n')
        writeFile.write('    location	"system";\n')
        writeFile.write('    object	snappyHexMeshDict;}\n\n')
        writeFile.write('#include	"../UISettings"\n\n')
        ...
        for surface in surfaces:
            writeFile.write(surface + '.stl {\n')
            writeFile.write('    name	' + surface + ';\n')
            writeFile.write('    type	triSurfaceMesh;}\n')
        writeFile.write('}\n')

        writeFile.write('castellatedMeshControls {\n')
        writeFile.write('    locationInMesh	(2 2 -1);\n')
        ...
        writeFile.write('    refinementRegions { }\n')
        writeFile.write('    features ();\n')
        writeFile.write('    minRefinementCells	0;\n')
        writeFile.write('    maxGlobalCells	10000000;\n')
        writeFile.write('    resolveFeatureAngle	5;\n')
        writeFile.write('    nCellsBetweenLevels	1;\n')
        writeFile.write('    maxLocalCells	500000;\n')
        writeFile.write('    allowFreeStandingZoneFaces	true;\n')
        writeFile.write('}\n')
        writeFile.write('snapControls {\n')
        writeFile.write('    nSmoothPatch 3;\n')
        writeFile.write('    tolerance	1;\n')
        writeFile.write('    nSolveIter	300;\n')
        writeFile.write('    nRelaxIter	5;\n')
        writeFile.write('    nFeatureSnapIter	10;\n')
